...
devMap['min-bionic-x64']    = '/dev/sda1=:8:true:gp3,/dev/sdd=:80:true:gp3'
...
devMap['min-ol-9-x64']      = '/dev/sda1=:10:true:gp3,/dev/sdd=:80:true:gp3'
...
devMap['min-buster-x64']    = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'
...
devMap['min-bookworm-x64']  = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-bullseye-x64']  = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-trixie-x64']    = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['docker-32gb-resolute'] = devMap['docker']
devMap['docker-32gb-bullseye']  = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'

devMap['min-centos-7-aarch64'] = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'
...
devMap['min-al2023-aarch64']   = '/dev/xvda=:8:true:gp3,/dev/xvdd=:80:true:gp3'
