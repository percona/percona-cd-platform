/**
 * cloud-staging fence. Runs FIRST (init.groovy.d is alphabetical) on every boot.
 * JENKINS_HOME is restored from a snapshot of production cloud, so at JVM start
...
location.setUrl('https://cloud-staging.cd.percona.com/')
location.save()
