/**
 * pmm-staging fence. Runs FIRST (init.groovy.d is alphabetical) on every boot.
 * JENKINS_HOME is restored from a snapshot of production pmm, so at JVM start
...
location.setUrl('https://pmm-staging.cd.percona.com/')
location.save()
