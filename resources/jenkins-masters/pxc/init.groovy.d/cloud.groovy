...
netMap = [:]
netMap['us-west-1b'] = 'subnet-0243d22c9d1b6ca38' // TF VPC vpc-0a7fa6852eaf1f2da (10.156.1.0/24)
netMap['us-west-1c'] = 'subnet-00825bb657d009b4b' // TF VPC vpc-0a7fa6852eaf1f2da (10.156.2.0/24)
...
devMap = [:]
devMap['docker']            = '/dev/xvda=:20:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['docker-32gb']       = devMap['docker']
devMap['micro-amazon']      = devMap['docker']
devMap['min-bionic-x64']    = '/dev/sda1=:12:true:gp3,/dev/sdd=:80:true:gp3'
...
devMap['min-centos-8-x64']  = '/dev/sda1=:12:true:gp3,/dev/sdd=:80:true:gp3'
devMap['min-ol-8-x64']      = '/dev/sda1=:12:true:gp3,/dev/sdd=:80:true:gp3'
devMap['min-ol-9-x64']      = '/dev/sda1=:12:true:gp3,/dev/sdd=:80:true:gp3'
devMap['fips-centos-7-x64'] = devMap['min-bionic-x64']
devMap['min-stretch-x64']   = 'xvda=:8:true:gp3,xvdd=:80:true:gp3'
devMap['min-buster-x64']    = '/dev/xvda=:12:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-bullseye-x64']  = '/dev/xvda=:12:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-bookworm-x64']  = '/dev/xvda=:12:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-trixie-x64']    = '/dev/xvda=:12:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-rhel-10-x64']   = '/dev/sda1=:12:true:gp3,/dev/sdd=:80:true:gp3'
devMap['min-xenial-x64']    = devMap['min-bionic-x64']
devMap['min-centos-6-x32']  = '/dev/sda=:12:true:gp3,/dev/sdd=:80:true:gp3'
devMap['min-al2023-x64']    = '/dev/xvda=:12:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['min-al2023-aarch64'] = '/dev/xvda=:12:true:gp3,/dev/xvdd=:80:true:gp3'
devMap['metal-x64']     = '/dev/sda1=:500:true:gp3'
devMap['metal-aarch64'] = '/dev/sda1=:500:true:gp3'

devMap['ramdisk-centos-6-x64'] = '/dev/sda1=:12:true:gp3'
devMap['ramdisk-centos-7-x64'] = devMap['ramdisk-centos-6-x64']
devMap['ramdisk-centos-8-x64'] = '/dev/sda1=:12:true:gp3'
devMap['ramdisk-ol-8-x64']     = '/dev/sda1=:12:true:gp3'
devMap['ramdisk-ol-9-x64']     = '/dev/sda1=:12:true:gp3'
...
devMap['ramdisk-stretch-x64']  = 'xvda=:12:true:gp3'
devMap['ramdisk-buster-x64']   = '/dev/xvda=:12:true:gp3'
devMap['ramdisk-bullseye-x64'] = '/dev/xvda=:12:true:gp3'
devMap['ramdisk-bookworm-x64'] = '/dev/xvda=:12:true:gp3'

devMap['performance-centos-6-x64'] = '/dev/sda1=:8:true:gp3,/dev/sdd=:120:true:gp3'
...
SlaveTemplate getTemplate(String OSType, String AZ) {
    return new SlaveTemplate(
        ...
        '',                                         // String zone
        new SpotConfiguration(true, priceMap[OSType] ?: priceMap[typeMap[OSType]], false, '0'), // SpotConfiguration spotConfig
