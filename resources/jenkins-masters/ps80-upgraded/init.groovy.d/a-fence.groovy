/**
 * ps80-upgraded clone fence. Runs FIRST (init.groovy.d is alphabetical) on
 * every boot. The JENKINS_HOME on this master is restored from a snapshot of
 * production ps80, so at JVM start config.xml still carries prod's EC2 and
 ...
 *  - Jenkins URL to this host, so nothing advertises ps80.cd.percona.com.
 */
...
location.setUrl('https://ps80-upgraded.cd.percona.com/')
location.save()
