 ...
 * behavior below can never run on the clone (re-creating the ps80-htz cloud whose inherited API token could enumerate and reap production ps80's live Hetzner workers). a-fence.groovy has
