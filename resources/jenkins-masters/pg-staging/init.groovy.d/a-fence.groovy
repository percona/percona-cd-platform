/**
 * pg-staging fence. Runs FIRST (init.groovy.d is alphabetical) on every boot.
 * JENKINS_HOME is restored from a snapshot of production pg, so at JVM start
...
location.setUrl('https://pg-staging.cd.percona.com/')
location.save()
