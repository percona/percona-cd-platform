...
After [ADR 0018](../adr/0018-lgtm-single-az-collapse.md) added
...
The canonical stateful set after ADR 0018:
...
After ADR 0018's retention-policy values shipped, this runbook should
