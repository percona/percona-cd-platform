...
**Amended by:** [ADR 0046](0046-engineer-ssh-roster-in-ssm-synced-by-state-manager.md), the static-key fallback is fed from an SSM roster synced by State Manager, and the committed `ssh_key_engineers` lists are gone.
